...
var _callbackStream = require('callback-stream');

var _callbackStream2 = _interopRequireDefault(_callbackStream);
  ...
  _createClass(Swagger, [{
    ...
    value: function initialize(next) {
      ...
      if (this.sails.config.swagger.jsdoc.path) {
        var pipeEnd = (0, _callbackStream2['default'])(next);
        (0, _jsdocParse2['default'])({ src: this.sails.config.swagger.jsdoc.path }).pipe(_eventStream2['default'].map(function (jsDoc, cb) {
          try {
